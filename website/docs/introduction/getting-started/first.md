...
The easiest way to browse the YAML manifests for the sample application and the modules in this workshop is using the file browser in Cloud9. Expanding the `environment/workspace/manifest` directory will show all of the components in the sample application:
